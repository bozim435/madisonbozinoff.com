...
const IO1 = {
	...
	heading: "Thesis 1",
	date: "2017",
	descrip: "Thesis 1 explores the possibilities of instruction-based methods in both image-making and typography. By extending the concept of rule-based art to the program, Thesis 1 investigates whether a set of instructions executed in code can produce unexpected and sometimes poetic results. </p><p>Nine twitter bots create and post images that respond to their individualized sets of instructions. These instructions define a range of compositions consisting solely of circles on a white square canvas. Similarly, a tenth bot generates single-line letterforms on a white square canvas. The outputs from the ten twitter bots are systematically placed into a grid to be drawn with a pen plotter as physical documentation. <a href='https://twitter.com/dewy_jojoba/lists/thesis/members' target='blank'>See twitter bots</a> <a href='pen-plotter-lines/index.html' target='blank'>See pen plotter close-ups</a>",
	path: "IO/IO.html"
...
const IO2 = {
	...
	heading: "Thesis 2",
	date: "2018",
	descrip: "Thesis 2 further explores instruction-based typography with programmatically generated letterforms. The typeface generated by the letterform twitter bot is exhibited in three browser-based animations. Tweets are pulled from twitter and typeset with the ever-changing letterforms. Each animation introduces more random elements into the program. See animations: <a href='input-output/random-letterform/index.html' target='blank'>1</a> <a href='input-output/random-stroke-full/index.html' target='blank'>2</a> <a href='input-output/random-stroke-individual/index.html' target='blank'>3</a>",
	path: "#"
...
const LFL = {
	...
	icons: ["LFL-Location-01.png", "LFL-Location-02.png", "GO.png", "LFL-01.png", "LFL-02.png", "LFL-03.png", "LFL-04.png", "LFL-05.png", "LFL-Process-03.png", "LFL-AppStore-01.png", "LFL-AppStore-02.png"],
