...
let IO2 = {
	...
	descrip: "Input Output 2 further explores instruction-based typography with programmatically generated letterforms. The typeface generated by the typeface twitter bot is exhibited in three browser-based animations where each letterform is replace by a new one every half-second. Each animation introduces more randomness into the program.",
	path: "#"
...
let RGB = {
	...
	descrip: "RGB Location translates a users location into an colour by converting the longitude, latitude, and altitude into red, green, and blue values.",
	path: "RGB/RGB.html"
...
let SB = {
	...
	descrip: "Sidebar is a publishing platform about internet culture. The journal features philosophical writings, personal stories, poetry, fine art, and theories, focussed on the internet.",
